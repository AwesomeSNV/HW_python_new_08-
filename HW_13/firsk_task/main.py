...
class DataException(Exception):
    ...
    def __str__(self):
        return f'Tреугольник со сторонами {self.side_a}, {self.side_b}, {self.side_c} не может существовать'
...
class DataTypeError(Exception):
    ...
    def __str__(self):
        return f'Bведен параметр неверного типа : {type(self.value)}'
...
class Triangle:
    ...
    def type_check(self):
        result = f"Tреугольник со сторонами {self.side_a}, {self.side_b}, {self.side_c} существует"
...
print("Bведите стороны треугольника а, b, c")
